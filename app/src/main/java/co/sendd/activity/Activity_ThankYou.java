    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() != null) {
            if (getIntent().getExtras().getBoolean("PickLater")) {
                text.setText("Parcel booked successfully. Sendd representative will be at your doorstep at your scheduled time. Sit back and relax.");
            } else if (!getIntent().getExtras().getBoolean("PickLater")) {
                text.setText("Parcel booked successfully. Sendd representative will be at your doorstep within an hour. Sit back and relax.");
            }
        }
