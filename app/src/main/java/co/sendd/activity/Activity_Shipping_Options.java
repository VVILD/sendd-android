...
public class Activity_Shipping_Options extends BaseActivity {
    private RadioGroup ShippingOption;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ShippingOption = (RadioGroup) findViewById(R.id.rgSphippingSpeed);
        int selectedId = ShippingOption.getCheckedRadioButtonId();
        ...
        getEstimate.setOnClickListener(new View.OnClickListener() {
                                           ...
                                           public void onClick(View v) {
                                               ...
                                               dialog.findViewById(R.id.bEstimate).setOnClickListener(new View.OnClickListener() {
                                                                                                          @Override
                                                                                                          public void onClick(View v) {
                                                                                                                              ...
                                                                                                                              if (mnetworkutils.isnetconnected()) {
                                                                                                                                  ...
                                                                                                                                  mnetworkutils.getapi().getPrice(shippingPrice, new Callback<ShippingPrice>() {
                                                                                                                                      ...
                                                                                                                                      public void failure(RetrofitError error) {
                                                                                                                                          ...
                                                                                                                                          Toast.makeText(Activity_Shipping_Options.this, "Error please try again", Toast.LENGTH_SHORT).show();
                                                                                                                                          pd.dismiss();
                                                                                                                                          dialog.dismiss();
